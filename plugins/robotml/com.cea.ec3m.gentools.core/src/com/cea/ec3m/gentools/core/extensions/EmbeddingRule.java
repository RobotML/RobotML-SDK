...
public class EmbeddingRule {
	...
	public static final String IINSTANCE_CONFIG_ID = Activator.PLUGIN_ID + ".embeddingRule";
	 ...
	 * @param instance
	 */
	public static void configureInstance(InstanceSpecification executorIS, InstanceSpecification instance, Port port) {
	 ...
	 * @param instance
	 */
	public static void configureInstance(String iConfiguratorID, InstanceSpecification executorIS, InstanceSpecification instance, Port port) {
		IInstanceConfigurator iConfigurator = getInstanceConfigurator(iConfiguratorID);
		if(iConfigurator != null) {
			iConfigurator.configureInstance(executorIS, null, instance, port);
		}
	}
