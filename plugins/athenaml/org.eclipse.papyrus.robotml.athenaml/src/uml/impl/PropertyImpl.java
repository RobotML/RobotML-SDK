...
public class PropertyImpl extends StructuralFeatureImpl implements Property {
	...
	public Interface getInterface() {
		if (eContainerFeatureID() != UmlPackage.PROPERTY__INTERFACE) return null;
	...
	public void setInterface(Interface newInterface) {
		if (newInterface != eInternalContainer() || (eContainerFeatureID() != UmlPackage.PROPERTY__INTERFACE && newInterface != null)) {
			...
			if (newInterface != null)
				msgs = ((InternalEObject)newInterface).eInverseAdd(this, UmlPackage.INTERFACE__OWNED_ATTRIBUTE, Interface.class, msgs);
			msgs = basicSetInterface(newInterface, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UmlPackage.PROPERTY__INTERFACE, newInterface, newInterface));
	}
	...
	public void setIsId(boolean newIsId) {
		...
		isId = newIsId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UmlPackage.PROPERTY__IS_ID, oldIsId, isId));
	}
