...
public class EcoreAdapterFactory extends AdapterFactoryImpl {
	...
	protected EcoreSwitch<Adapter> modelSwitch =
		new EcoreSwitch<Adapter>() {
			...
			@Override
			public Adapter caseEClassifier_Wildcard(EClassifier_Wildcard object) {
				return createEClassifier_WildcardAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseEStructuralFeature_Wildcard(EStructuralFeature_Wildcard object) {
				return createEStructuralFeature_WildcardAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link ecore.EClassifier_Wildcard <em>EClassifier Wildcard</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createEClassifier_WildcardAdapter() {
		return null;
	}
	...
	/**
	 * Creates a new adapter for an object of class '{@link ecore.EStructuralFeature_Wildcard <em>EStructural Feature Wildcard</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createEStructuralFeature_WildcardAdapter() {
		return null;
	}
