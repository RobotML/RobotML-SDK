...
public class InterfaceImpl extends ClassifierImpl implements Interface {
	...
	public EList<Property> getOwnedAttribute() {
		if (ownedAttribute == null) {
			ownedAttribute = new EObjectContainmentWithInverseEList<Property>(Property.class, this, UmlPackage.INTERFACE__OWNED_ATTRIBUTE, UmlPackage.PROPERTY__INTERFACE);
		}
