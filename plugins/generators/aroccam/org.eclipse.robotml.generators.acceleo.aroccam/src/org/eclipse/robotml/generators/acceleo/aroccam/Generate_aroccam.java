...
/**
 * Entry point of the 'Generate_aroccam' generation module.
 * 
 * @generated
 */
public class Generate_aroccam extends AbstractAcceleoGenerator {
	 ...
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "generateAroccamDiagram" };
	 ...
	 * @generated
	 */
	public Generate_aroccam(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public Generate_aroccam(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
	...
	public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                Generate_aroccam generator = new Generate_aroccam(modelURI, folder, arguments);
