...
/**
 * Entry point of the 'GenerateVLE' generation module.
 *
 * @generated
 */
public class GenerateVLE extends AbstractAcceleoGenerator {
     ...
     * @generated NOT
     */
    public GenerateVLE(URI modelURI, File targetFolder,
...
//    	org.xtext.athenaDSL.impl.AthenaDSLPackageImpl.init();
     ...
     * @generated NOT
     */
    public GenerateVLE(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
...
//    	org.xtext.athenaDSL.impl.AthenaDSLPackageImpl.init();
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                GenerateVLE generator = new GenerateVLE(modelURI, folder, arguments);
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        {
        	System.out.println("===> Athena not in workspace ....");
