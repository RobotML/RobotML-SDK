...
public class FCMPackageImpl extends EPackageImpl implements FCMPackage {
	 ...
	 * 
	 * <p>
	 * This method is used to initialize {@link FCMPackage#eINSTANCE} when that field is accessed. Clients should not invoke it directly. Instead,
	 ...
	 * @generated
	 */
	public EReference getInterceptionRule_PortSet() {
	...
	public void createPackageContents() {
		...
		createEReference(interceptionRuleEClass, INTERCEPTION_RULE__PORT_SET);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getRuleApplication_PropagateRule(), ecorePackage.getEBoolean(), "propagateRule", null, 0, -1, RuleApplication.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getInteractionComponent_ForDistribution(), ecorePackage.getEBoolean(), "forDistribution", "false", 1, 1, InteractionComponent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getPortKind_ExtendedPort(), ecorePackage.getEBoolean(), "extendedPort", null, 1, 1, PortKind.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getPort_Conjugated(), ecorePackage.getEBoolean(), "conjugated", null, 1, 1, Port.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getCompImplTemplate_TemplateDefs(), ecorePackage.getEString(), "templateDefs", null, 0, 1, CompImplTemplate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getCppLibrary_Macros(), ecorePackage.getEString(), "macros", null, 0, -1, CppLibrary.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getCppLibrary_Libs(), ecorePackage.getEString(), "libs", null, 0, -1, CppLibrary.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getCppLibrary_LibPaths(), ecorePackage.getEString(), "libPaths", null, 0, -1, CppLibrary.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getCppLibrary_IncludePaths(), ecorePackage.getEString(), "includePaths", null, 0, -1, CppLibrary.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getJavaLibrary_ClassPath(), ecorePackage.getEString(), "classPath", null, 0, -1, JavaLibrary.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getImplementationProperties_SizeRAM(), ecorePackage.getEInt(), "sizeRAM", null, 1, 1, ImplementationProperties.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getImplementationProperties_SizeROM(), ecorePackage.getEInt(), "sizeROM", null, 1, 1, ImplementationProperties.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getInterceptionRule_PortSet(), this.getPort(), null, "portSet", null, 0, -1, InterceptionRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getTarget_AvailRAM(), ecorePackage.getEInt(), "availRAM", null, 1, 1, Target.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getTarget_AvailROM(), ecorePackage.getEInt(), "availROM", null, 1, 1, Target.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		addEEnumLiteral(interceptionKindEEnum, InterceptionKind.INTERCEPT_SOME_PORTS);
		addEEnumLiteral(interceptionKindEEnum, InterceptionKind.INTERCEPT_ALL_PORTS);
		addEEnumLiteral(interceptionKindEEnum, InterceptionKind.INTERCEPT_ALL_OUT_PORTS);
		addEEnumLiteral(interceptionKindEEnum, InterceptionKind.INTERCEPT_ALL_IN_PORTS);
