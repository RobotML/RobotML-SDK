...
public class Geometry_datatypesFactoryImpl extends EFactoryImpl implements Geometry_datatypesFactory {
	...
	public static Geometry_datatypesFactory init() {
		try {
			Geometry_datatypesFactory theGeometry_datatypesFactory = (Geometry_datatypesFactory)EPackage.Registry.INSTANCE.getEFactory("http:///ProteusLibraries/RobotML_ModelLibrary/RobotML_DataTypes/geometry_datatypes.ecore"); 
