...
public abstract class BehaviorImpl extends ClassImpl implements Behavior {
	...
	public void setIsReentrant(boolean newIsReentrant) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UmlPackage.BEHAVIOR__IS_REENTRANT, oldIsReentrant, isReentrant, !oldIsReentrantESet));
	}
	...
	public void unsetIsReentrant() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, UmlPackage.BEHAVIOR__IS_REENTRANT, oldIsReentrant, IS_REENTRANT_EDEFAULT, oldIsReentrantESet));
	}
