...
public class Std_datatypesFactoryImpl extends EFactoryImpl implements Std_datatypesFactory {
	...
	public static Std_datatypesFactory init() {
		try {
			Std_datatypesFactory theStd_datatypesFactory = (Std_datatypesFactory)EPackage.Registry.INSTANCE.getEFactory("http:///ProteusLibraries/RobotML_ModelLibrary/RobotML_DataTypes/std_datatypes.ecore"); 
