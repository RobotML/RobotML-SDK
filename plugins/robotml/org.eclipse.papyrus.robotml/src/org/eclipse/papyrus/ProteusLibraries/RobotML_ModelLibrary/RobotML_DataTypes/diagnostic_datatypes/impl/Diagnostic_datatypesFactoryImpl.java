...
public class Diagnostic_datatypesFactoryImpl extends EFactoryImpl implements Diagnostic_datatypesFactory {
	...
	public static Diagnostic_datatypesFactory init() {
		try {
			Diagnostic_datatypesFactory theDiagnostic_datatypesFactory = (Diagnostic_datatypesFactory)EPackage.Registry.INSTANCE.getEFactory("http:///ProteusLibraries/RobotML_ModelLibrary/RobotML_DataTypes/diagnostic_datatypes.ecore"); 
