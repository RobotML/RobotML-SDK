...
import org.eclipse.papyrus.robotml.generators.cycabtk.ui.Activator;
...
/**
 * The Class AcceleoGenerateCycabTKCommandHandler.
 */
public class AcceleoGenerateCycabTKCommandHandler extends AbstractHandler {

	/** The cycabtk folder. */
	private final String cycabtkFolder = "cycabtk-generated-files";
...
//			return new org.eclipse.papyrus.commands.wrappers.GMFtoEMFCommandWrapper(new GenerateCycabTKCodeCommand("Generate CycabTK code command", editingDomain, selectedObject, targetPath + cycabtkFolder));
//		}
//			
//		
//return null;
...
//	}
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (selection instanceof IStructuredSelection){
			...
			URI targetFolderURI = resourceURI.trimSegments(1).appendSegment(cycabtkFolder);
			...
			try {
				...
				ICommand generationCommand = new GenerateCycabTKCodeCommand("Generate CycabTK code command", editingDomain, selectedElement, targetFolderURI.toPlatformString(true));
