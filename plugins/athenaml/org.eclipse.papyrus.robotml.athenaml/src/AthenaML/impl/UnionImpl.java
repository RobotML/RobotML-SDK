 ...
 * <ul>
 *   <li>{@link AthenaML.impl.UnionImpl#getTypes <em>Types</em>}</li>
 *   <li>{@link AthenaML.impl.UnionImpl#getBaseDataType <em>Base Data Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UnionImpl extends EObjectImpl implements Union {
		...
		if (baseDataType != null && baseDataType.eIsProxy()) {
			...
			if (baseDataType != oldBaseDataType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AthenaMLPackage.UNION__BASE_DATA_TYPE, oldBaseDataType, baseDataType));
			}
		}
		return baseDataType;
	}
	...
	public void setBaseDataType(DataType newBaseDataType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AthenaMLPackage.UNION__BASE_DATA_TYPE, oldBaseDataType, baseDataType));
	}
