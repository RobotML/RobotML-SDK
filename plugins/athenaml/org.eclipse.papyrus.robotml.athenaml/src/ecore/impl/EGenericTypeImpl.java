...
public class EGenericTypeImpl extends EObjectImpl implements EGenericType {
	...
	public EClassifier getERawType() {
		EClassifier eRawType = basicGetERawType();
		return eRawType != null && eRawType.eIsProxy() ? (EClassifier)eResolveProxy((InternalEObject)eRawType) : eRawType;
	}
	...
	public EClassifier basicGetERawType() {
		// TODO: implement this method to return the 'ERaw Type' reference
