...
/**
 * Entry point of the 'GenerateProcessings' generation module.
 *
 * @generated
 */
public class GenerateProcessings extends AbstractAcceleoGenerator {
	/**
	 * The name of the module.
	 *
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "generateProcessings";
	 ...
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "generateProcessings", };
	 ...
	 * @generated
	 */
	public GenerateProcessings(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public GenerateProcessings(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
	...
	public static void main(String[] args) {
		try {
			if (args.length < 2) {
				...
				GenerateProcessings generator = new GenerateProcessings(modelURI, folder, arguments);
