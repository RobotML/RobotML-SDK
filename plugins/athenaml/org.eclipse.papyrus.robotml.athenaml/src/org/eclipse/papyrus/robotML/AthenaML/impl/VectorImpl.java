 ...
 * <ul>
 *   <li>{@link org.eclipse.papyrus.robotML.AthenaML.impl.VectorImpl#getSize <em>Size</em>}</li>
 *   <li>{@link org.eclipse.papyrus.robotML.AthenaML.impl.VectorImpl#getType_template <em>Type template</em>}</li>
 *   <li>{@link org.eclipse.papyrus.robotML.AthenaML.impl.VectorImpl#getBase_DataType <em>Base Data Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VectorImpl extends EObjectImpl implements Vector {
	...
	public DataType getType_template() {
		if (type_template != null && type_template.eIsProxy()) {
			...
			if (type_template != oldType_template) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AthenaMLPackage.VECTOR__TYPE_TEMPLATE, oldType_template, type_template));
			}
		}
	...
	public void setType_template(DataType newType_template) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AthenaMLPackage.VECTOR__TYPE_TEMPLATE, oldType_template, type_template));
	}
	...
	public DataType getBase_DataType() {
		if (base_DataType != null && base_DataType.eIsProxy()) {
			...
			if (base_DataType != oldBase_DataType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AthenaMLPackage.VECTOR__BASE_DATA_TYPE, oldBase_DataType, base_DataType));
			}
		}
	...
	public void setBase_DataType(DataType newBase_DataType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AthenaMLPackage.VECTOR__BASE_DATA_TYPE, oldBase_DataType, base_DataType));
	}
