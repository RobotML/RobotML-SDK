...
/**
 * Aroccam code generation.
 */
public class AcceleoGenerateAroccamAction extends ActionDelegate implements IActionDelegate {
				...
				public void run(IProgressMonitor monitor) {
					try {
						...
						while (filesIt.hasNext()) {
							...
							try {
								IContainer target = model.getProject().getFolder("aroccam-generated-files");
