 ...
 * <ul>
 *   <li>{@link AthenaML.impl.MapImpl#getValuesType <em>Values Type</em>}</li>
 *   <li>{@link AthenaML.impl.MapImpl#getBaseDataType <em>Base Data Type</em>}</li>
 *   <li>{@link AthenaML.impl.MapImpl#getKeysType <em>Keys Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MapImpl extends EObjectImpl implements Map {
		...
		if (valuesType != null && valuesType.eIsProxy()) {
			...
			if (valuesType != oldValuesType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AthenaMLPackage.MAP__VALUES_TYPE, oldValuesType, valuesType));
			}
		}
		return valuesType;
	}
	...
	public void setValuesType(DataType newValuesType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AthenaMLPackage.MAP__VALUES_TYPE, oldValuesType, valuesType));
	}
	...
	public DataType getBaseDataType() {
		if (baseDataType != null && baseDataType.eIsProxy()) {
			...
			if (baseDataType != oldBaseDataType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AthenaMLPackage.MAP__BASE_DATA_TYPE, oldBaseDataType, baseDataType));
			}
		}
		return baseDataType;
	}
	...
	public void setBaseDataType(DataType newBaseDataType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AthenaMLPackage.MAP__BASE_DATA_TYPE, oldBaseDataType, baseDataType));
	}
	...
	public DataType getKeysType() {
		if (keysType != null && keysType.eIsProxy()) {
			...
			if (keysType != oldKeysType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AthenaMLPackage.MAP__KEYS_TYPE, oldKeysType, keysType));
			}
		}
		return keysType;
	}
	...
	public void setKeysType(DataType newKeysType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AthenaMLPackage.MAP__KEYS_TYPE, oldKeysType, keysType));
	}
