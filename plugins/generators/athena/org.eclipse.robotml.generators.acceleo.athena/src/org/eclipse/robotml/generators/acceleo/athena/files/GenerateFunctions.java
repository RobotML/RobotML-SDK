...
/**
 * Entry point of the 'GenerateFunctions' generation module.
 *
 * @generated
 */
public class GenerateFunctions extends AbstractAcceleoGenerator {
	/**
	 * The name of the module.
	 *
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "generateFunctions";
	 ...
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "generateFunctions", };
	 ...
	 * @generated
	 */
	public GenerateFunctions(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public GenerateFunctions(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
	...
	public static void main(String[] args) {
		try {
			if (args.length < 2) {
				...
				GenerateFunctions generator = new GenerateFunctions(modelURI, folder, arguments);
