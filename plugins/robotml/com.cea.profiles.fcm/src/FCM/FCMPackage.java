...
public interface FCMPackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>Port Set</b></em>' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int INTERCEPTION_RULE__PORT_SET = 1;
	 ...
	 * @ordered
	 */
	int INTERCEPTION_RULE_FEATURE_COUNT = 3;
	...
	/**
	 * Returns the meta object for the reference list '{@link FCM.InterceptionRule#getPortSet <em>Port Set</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Port Set</em>'.
	 * @see FCM.InterceptionRule#getPortSet()
	 * @see #getInterceptionRule()
	 * @generated
	 */
	EReference getInterceptionRule_PortSet();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Port Set</b></em>' reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference INTERCEPTION_RULE__PORT_SET = eINSTANCE.getInterceptionRule_PortSet();
