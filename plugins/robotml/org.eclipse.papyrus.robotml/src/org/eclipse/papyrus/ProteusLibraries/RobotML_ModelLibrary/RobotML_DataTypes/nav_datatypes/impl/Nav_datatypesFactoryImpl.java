...
public class Nav_datatypesFactoryImpl extends EFactoryImpl implements Nav_datatypesFactory {
	...
	public static Nav_datatypesFactory init() {
		try {
			Nav_datatypesFactory theNav_datatypesFactory = (Nav_datatypesFactory)EPackage.Registry.INSTANCE.getEFactory("http:///ProteusLibraries/RobotML_ModelLibrary/RobotML_DataTypes/nav_datatypes.ecore"); 
