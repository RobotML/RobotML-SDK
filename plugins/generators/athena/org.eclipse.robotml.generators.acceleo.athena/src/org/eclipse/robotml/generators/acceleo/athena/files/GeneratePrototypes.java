...
/**
 * Entry point of the 'GeneratePrototypes' generation module.
 *
 * @generated
 */
public class GeneratePrototypes extends AbstractAcceleoGenerator {
	/**
	 * The name of the module.
	 *
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "generatePrototypes";
	 ...
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "generatePrototypes", };
	 ...
	 * @generated
	 */
	public GeneratePrototypes(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public GeneratePrototypes(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
    ...
    try {
      if (args.length < 2) {
        ...
        GeneratePrototypes generator = new GeneratePrototypes(modelURI, folder, arguments);
