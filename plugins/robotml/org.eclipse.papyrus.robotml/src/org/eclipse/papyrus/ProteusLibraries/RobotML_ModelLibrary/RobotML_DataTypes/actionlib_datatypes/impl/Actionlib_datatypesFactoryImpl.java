...
public class Actionlib_datatypesFactoryImpl extends EFactoryImpl implements Actionlib_datatypesFactory {
	...
	public static Actionlib_datatypesFactory init() {
		try {
			Actionlib_datatypesFactory theActionlib_datatypesFactory = (Actionlib_datatypesFactory)EPackage.Registry.INSTANCE.getEFactory("http:///ProteusLibraries/RobotML_ModelLibrary/RobotML_DataTypes/actionlib_datatypes.ecore"); 
