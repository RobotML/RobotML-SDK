...
public class Main extends AbstractAcceleoGenerator {
	...
	public static final String PROTEUS_PROFILE_URI = PROFILES_PATHMAP + "ProteusProfile.profile.uml"; //$NON-NLS-1$
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/org/eclipse/acceleo/module/OrocosGenerator/main/main";
    ...
    public void registerPackages(ResourceSet resourceSet) {
		...
		resourceSet.getPackageRegistry().put(RobotMLPackage.eINSTANCE.getNsURI(), RobotMLPackage.eINSTANCE);
