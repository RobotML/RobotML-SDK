...
import org.eclipse.papyrus.robotml.deployment.transformations.PrefixConstants;
...
//import com.cea.ec3m.gentools.core.transformations.CompImplTrafos;
...
public class BootLoaderGen {
	...
	public BootLoaderGen(Copy copy, int nodeIndex, int numberOfNodes)
		 ...
		 * }
		 */
		StUtils.apply(m_bootLoader, Stereotypes.cppInclude);
		Object existingBody = StUtils.getAttribute(m_bootLoader, Stereotypes.cppInclude, "body");
		...
		StUtils.setAttribute(m_bootLoader, Stereotypes.cppInclude, "body", existingBodyStr + bodyStr);
...
//				}
	...
	private final static String bootloaderQNAME = "BasicCalls::composites::BootLoader";
