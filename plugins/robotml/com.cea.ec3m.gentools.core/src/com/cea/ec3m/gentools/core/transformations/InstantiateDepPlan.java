...
import com.cea.ec3m.gentools.core.acceleo.EnumService;
...
import com.cea.ec3m.gentools.core.deployment.Deploy;
import com.cea.ec3m.gentools.core.extensions.ILangSupport;
import com.cea.ec3m.gentools.core.extensions.LanguageSupport;
import com.cea.ec3m.gentools.core.generate.GenerateCode;
import com.cea.ec3m.gentools.core.generate.GenerationOptions;
import com.cea.ec3m.gentools.core.transformations.filters.FilterComments;
import com.cea.ec3m.gentools.core.transformations.filters.FilterStateMachines;
...
public class InstantiateDepPlan {
	...
	public static void instantiate(Element cdpOrConfig, IProgressMonitor monitor, IProject project, int genOptions) {
		...
		ClassLoader loader = InstantiateDepPlan.class.getClassLoader();
		...
		try {
			...
			ContainerTrafo.init();
			InstanceSpecification newRootIS = MainModelTrafo.mainModelTrafo(tmpCopy, tmCDP, rootIS, null, new BasicEList<ContainerRule>());
			monitor.worked(1);
	...
	public static ModelManagement createTargetModel(Model existingModel, IProgressMonitor monitor, String name, boolean copyImports) throws TransformationException {
		...
		try {
			...
			for(Profile profile : existingModel.getAppliedProfiles()) {
				...
				Resource profileResource = ModelManagement.getResourceSet().getResource(profile.eResource().getURI(), true);
