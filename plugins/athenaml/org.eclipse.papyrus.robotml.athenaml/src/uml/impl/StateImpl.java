...
public class StateImpl extends NamespaceImpl implements State {
	...
	public Constraint getStateInvariant() {
		if (stateInvariant != null && stateInvariant.eIsProxy()) {
			...
			if (stateInvariant != oldStateInvariant) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UmlPackage.STATE__STATE_INVARIANT, oldStateInvariant, stateInvariant));
			}
		}
	...
	public void setStateInvariant(Constraint newStateInvariant) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UmlPackage.STATE__STATE_INVARIANT, oldStateInvariant, stateInvariant));
	}
