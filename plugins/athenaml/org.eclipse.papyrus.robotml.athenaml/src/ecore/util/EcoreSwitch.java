...
public class EcoreSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case EcorePackage.ECLASSIFIER_WILDCARD: {
				EClassifier_Wildcard eClassifier_Wildcard = (EClassifier_Wildcard)theEObject;
				T result = caseEClassifier_Wildcard(eClassifier_Wildcard);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case EcorePackage.ESTRUCTURAL_FEATURE_WILDCARD: {
				EStructuralFeature_Wildcard eStructuralFeature_Wildcard = (EStructuralFeature_Wildcard)theEObject;
				T result = caseEStructuralFeature_Wildcard(eStructuralFeature_Wildcard);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>EClassifier Wildcard</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>EClassifier Wildcard</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseEClassifier_Wildcard(EClassifier_Wildcard object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>EStructural Feature Wildcard</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>EStructural Feature Wildcard</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseEStructuralFeature_Wildcard(EStructuralFeature_Wildcard object) {
		return null;
	}
