...
/**
 * Entry point of the 'GenerateImport' generation module.
 *
 * @generated
 */
public class GenerateImport extends AbstractAcceleoGenerator {
	/**
	 * The name of the module.
	 *
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "generateImport";
	 ...
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "generateImport", };
	 ...
	 * @generated
	 */
	public GenerateImport(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public GenerateImport(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
    ...
    try {
      if (args.length < 2) {
        ...
        GenerateImport generator = new GenerateImport(modelURI, folder, arguments);
